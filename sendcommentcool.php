...
<textarea cols="40" rows="8" id="message" name="message"></textarea><br />
 <input name="idblogowner" type="hidden" value="<?php echo $idtemp;?>" />
  <input name="letemps" type="hidden" value="<?php echo $cooltime;?>" />
  <input name="idblog" type="hidden" value="<?php echo $idcooltaf;?>" />
  <input name="typeth" type="hidden" value="<?php echo "cooltof";?>" />
