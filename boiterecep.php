...
<table width="750" border="0" align="left" > 
    <tr>
     ...
     <td width="150" valign="top"><?php  include("menuboiterecep.php");?></td>
    ...
    <iframe 
      <?php 
	  if(isset($_GET['not']) AND $_GET['not']=="notification.php"){
	   echo'src="notification.php"';
	  } else {
	  echo'src="affichemsg.php?m='.$id.'&amp;action='.md5($id."consulter").'"';
	  }
	  ?>
...
?>
      ...
      <iframe src="pub.php" name="cpub" width="200" marginwidth="2" height="500" 
      marginheight="2"      align="left" scrolling="no" frameborder="0" ></iframe>
      </td>
